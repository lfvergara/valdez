...
class ClienteView extends View {
	...
	function agregar($provincia_collection, $documentotipo_collection, $condicioniva_collection, $condicionfiscal_collection,
		...
		$gui_lst_listaprecio = file_get_contents("static/modules/cliente/lst_listaprecio.html");
		...
		$gui_lst_listaprecio = $this->render_regex('SLT_LISTAPRECIO', $gui_lst_listaprecio, $listaprecio_collection);
		...
		$render = str_replace('{lst_listaprecio}', $gui_lst_listaprecio, $render);
		$render = $this->render_breadcrumb($render);
		$template = $this->render_template($render);
		print $template;
	}
	...
	function editar($provincia_collection, $documentotipo_collection, $condicioniva_collection, $condicionfiscal_collection,
					$frecuenciaventa_collection, $vendedor_collection, $flete_collection, $tipofactura_collection, $obj_cliente,$listaprecio_collection) {
