...
class VendedorController {
	...
	function estadisticas() {
		...
		$this->view->estadisticas($vendedor_collection, $ventas_vendedor, $top3_vendedor_proveedor_final);
	}
	...
	function filtro_estadisticas() {
		...
		$this->view->filtro_estadisticas($vendedor_collection, $ventas_vendedor, $array_fechas, $top3_vendedor_proveedor_final);
	}
	...
	function descargar_visita_clientes() {
		...
		$array_encabezados = array('COD', 'CLIENTE', 'NOM FANTASIA', 'BARRIO', 'DOMICILIO');
