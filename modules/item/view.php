...
class ItemView extends View {
	...
	function editar($obj_item, $menu_collection, $submenu_collection, $item_collection) {
		$gui = file_get_contents("static/modules/menu/editar_item.html");
		...
		$obj_item = $this->set_dict($obj_item);
		$render = $this->render($obj_item, $gui);
